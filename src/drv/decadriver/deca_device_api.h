 ...
 */
extern uint32 dwt_readdevid(void);
 ...
 */
extern uint8 dwt_otprevision(void);
 ...
 * no return value
 */
extern void dwt_setGPIOforEXTTRX(void);
 ...
 * no return value
 */
extern void dwt_setGPIOdirection(uint32 gpioNum, uint32 direction);
 ...
 * no return value
 */
extern void dwt_setGPIOvalue(uint32 gpioNum, uint32 value);
 ...
 */
extern int dwt_initialise(uint16 config) ;
 ...
 * returns DWT_SUCCESS for success, or DWT_ERROR for error
 */
extern int dwt_configure(dwt_config_t *config) ;
 ...
 * no return value
 */
extern void dwt_configuretxrf(dwt_txconfig_t *config) ;
 ...
 * no return value
 */
extern void dwt_setrxantennadelay(uint16 antennaDly);
 ...
 * no return value
 */
extern void dwt_settxantennadelay(uint16 antennaDly);
 ...
 * no return value
 */
extern void dwt_setsmarttxpower(int enable);
 ...
 * returns DWT_SUCCESS for success, or DWT_ERROR for error
 */
extern int dwt_writetxdata(uint16 txFrameLength, uint8 *txFrameBytes, uint16 txBufferOffset) ;
 ...
 * returns DWT_SUCCESS for success, or DWT_ERROR for error
 */
extern int dwt_writetxfctrl(uint16 txFrameLength, uint16 txBufferOffset) ;
 ...
 */
extern int dwt_starttx(uint8 mode) ;
 ...
 * no return value
 */
extern void dwt_setdelayedtrxtime(uint32 starttime) ;
 ...
 */
extern uint32 dwt_readtxtimestamphi32(void);
 ...
 */
extern uint32 dwt_readtxtimestamplo32(void);
 ...
 */
extern uint32 dwt_readrxtimestamphi32(void);
 ...
 */
extern uint32 dwt_readrxtimestamplo32(void);
 ...
 */
extern uint32 dwt_readsystimestamphi32(void);
 ...
 * no return value
 */
extern void dwt_readsystime(uint8 * timestamp);
 ...
 */
extern int dwt_checkoverrun(void);
 ...
 * no return value
 */
extern void dwt_forcetrxoff(void);
 ...
 * no return value
 */
extern void dwt_syncrxbufptrs(void);
 ...
 */
extern int dwt_rxenable(int delayed) ;
...
extern void dwt_setrxmode(int mode, uint8 rxON, uint8 rxOFF);
 ...
 * no return value
 */
extern void dwt_setautorxreenable(int enable);
 ...
 * no return value
 */
extern void dwt_setdblrxbuffmode(int enable);
 ...
 * no return value
 */
extern void dwt_setrxtimeout(uint16 time);
 ...
 * no return value
 */
extern void dwt_setpreambledetecttimeout(uint16 timeout);
 ...
 */
extern uint16 dwt_calibratesleepcnt(void);
 ...
 * no return value
 */
 extern void dwt_configuresleepcnt(uint16 sleepcnt);
  ...
  * no return value
  */
extern void dwt_configuresleep(uint16 mode, uint8 wake);
 ...
 * no return value
 */
extern void dwt_entersleep(void);
 ...
 * no return value
 */
extern void dwt_entersleepaftertx(int enable);
 ...
 * returns DWT_SUCCESS for success, or DWT_ERROR for error
 */
extern int dwt_spicswakeup(uint8 *buff, uint16 length);
 ...
 * no return value
 */
extern void dwt_setcallbacks(void (*txcallback)(const dwt_callback_data_t *), void (*rxcallback)(const dwt_callback_data_t *));
 ...
 * no return value
 */
extern void dwt_setpanid(uint16 panID);
 ...
 * no return value
 */
extern void dwt_setaddress16(uint16 shortAddress);
 ...
 * no return value
 */
extern void dwt_seteui(uint8 *eui64);
 ...
 * no return value
 */
extern void dwt_geteui(uint8 *eui64);
